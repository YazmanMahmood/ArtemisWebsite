    ...
    return (
      <>
        <Helmet>
          ...
          <meta name="description" content="Discover Artemis AI-powered drones for security, agriculture, warehouse monitoring, and more. Advanced drone solutions for every industry. Explore Artemis drones now!" />
          <meta name="keywords" content="AI drones, Artemis drones, smart drones, security drones, agriculture drones, warehouse drones, industrial drones, drone technology, drone solutions, drone company, Artemis AI" />
          <meta property="og:title" content="Artemis AI Drones | Smart Drones for Security, Agriculture, and More" />
          <meta property="og:description" content="Discover Artemis AI-powered drones for security, agriculture, warehouse monitoring, and more. Advanced drone solutions for every industry." />
          <meta property="og:type" content="website" />
        </Helmet>
        {/* --- Sidebar --- */}
        <MenuToggle onClick={openSidebar} aria-label="Open Menu">
          <FaBars />
        </MenuToggle>
